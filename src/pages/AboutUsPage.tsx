...
const FeatureCard = ({
  ...
  return (
    <Card
      className={`w-full py-7 flex flex-col items-center justify-between max-w-sm flex-grow basis-[300px] outline-none border-none bg-secondary/100 rounded-3xl hover:shadow-lg transition-shadow ${backgroundColor} bg-opacity-5`}
    >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:my-8">
            ...
            <div className="w-full text-center py-8 bg-[#EDEDED] rounded-3xl">
              <h2 className="font-medium text-2xl lg:text-4xl text-gray-800 mb-6">
                Contact Us
              </h2>
              <ContactForm />
            </div>
                ...
                {[
                  {
                    ...
                    title: "Elite Network",
                    description:
                      "Access the top 1% of experts in your industry, carefully curated to meet your needs.",
                  },
                  {
                    className: "bg-[#f7f7ff]",
                    title: "Seamless Process",
                    description:
                      "Our platform simplifies hiring and job searching, saving you time and effort.",
                  },
                  {
                    className: "bg-[#f9fdf3]",
                    title: "Commitment to Success",
                    description:
                      "We are dedicated to driving your business or career forward with unmatched expertise.",
                  },
                ].map((feature, index) => (
                  <FeatureCard
                    key={index}
